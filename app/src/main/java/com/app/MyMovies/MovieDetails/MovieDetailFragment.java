package com.app.MyMovies.MovieDetails;
...
import com.app.MyMovies.Movie;
import com.app.MyMovies.MovieComponents.Reviews;
import com.app.MyMovies.MovieComponents.Trailers;
import com.app.MyMovies.R;
import com.app.MyMovies.databaseSQLITE.MovieContract;
import com.app.MyMovies.utilities.NetworkUtils;
...
public class MovieDetailFragment extends Fragment implements
    ...
    private void update_rating_stars() {
        if (mMovie.getVoteAverage() != null && !mMovie.getVoteAverage().isEmpty()) {
            @SuppressLint({"StringFormatInvalid", "LocalSuppress"}) String user_rating_star = getResources().getString(R.string.movie_user_rating,
        ...
        mButtonRemoveFromFavorites.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                       ...
                       // Toast.makeText(getActivity(), "Success Removed Favorite!",
                         //       Toast.LENGTH_LONG).show();
                        ...
                        NotificationCompat.Builder builder = (NotificationCompat.Builder) new NotificationCompat.Builder(getActivity())
                                ...
                                .setContentTitle("Favorite") //judul konten
                                .setAutoCancel(true)//untuk menswipe atau menghapus notification
                                .setContentText("Success Removed Favorite!"); //isi text
